export default function Footer() {
  return (
    <footer className="footer footer-padding-default footer--dark footer-l05 bg-black-3">
            ...
            <div className="footer__content-block">
              <div className="footer__content-text">
                <div className="footer-brand">
                  <img src="./image/logo-5-white.svg" alt="image alt" />
                </div>
                <p>
              ...
              <a href="#" className="footer-link">mascoexample@gmail.com</a>
              <br />
              <ul className="list-social list-social--primary-l5">
                <li>
                  <a href="#">
